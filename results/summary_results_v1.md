...
Generated: 2026-04-05 (updated — 10 datasets)
...
**All 10 datasets show negative objectives (incremental learning wins).**
...
## ClientRecordV2 Ablation (30t, ext=Offer+Monthly Charge)

| Mode | Objective | Ext AUC | Base AUC | Comb+ext |
|---|---|---|---|---|
| **optuna** | **-0.004647** | 0.9186 | 0.9235 | 0.9177 |
| no_pruning | -0.003799 | 0.9178 | 0.9235 | 0.9177 |
| fixed_50 | -0.003429 | 0.9174 | 0.9235 | 0.9177 |

All three modes show incremental wins.
...
1. **All 10 datasets achieve negative objectives** (incremental learning wins) in at least one configuration.
