#!/usr/bin/env python3
"""WIDS: Feature combo search + ablation study.
...
Usage:
    python run_wids_ablation.py
    python run_wids_ablation.py --test
"""
import sys
import os
...
RESULTS_DIR = os.path.join(SCRIPTS_DIR, '..', 'results', 'WIDS')
os.makedirs(RESULTS_DIR, exist_ok=True)

DATASET_NAME = 'WIDS'

# Quick test mode: python run_wids_ablation.py --test
...
def find_null_groups(df, label, min_null_rate=0.20, jaccard_threshold=0.95, max_groups=3):
