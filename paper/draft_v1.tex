...
ClientRecord & Augmented & $0.12$ & 0.503 & Random \\
...
Across all 10 datasets, our framework achieves positive or zero weighted improvement, demonstrating that incremental learning without data sharing incurs no performance loss compared to standard training (Wilcoxon $p = 0.002$). The strongest gains appear in BankLoanSta (+0.0294), HRAnalytics (+0.0049), MovieAugV2 (+0.0028), and Weather (+0.0027).
...
\textbf{Statistical significance.} All 10 datasets show positive or zero weighted improvement. A Wilcoxon signed-rank test confirms statistical significance ($W = 0$, $p = 0.004$). The median weighted improvement is +0.0018 AUC.
...
ClientRecord & \textbf{--0.0015} & --0.0009 & --0.0006 & Optuna & 0.9186 \\
