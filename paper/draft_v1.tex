...
Our analysis reveals why this approach incurs no performance loss: under structured missingness, the two-phase design enables population-specific specialization as an emergent benefit. The base model matches or exceeds the combined baseline on the feature-absent population in all 10 evaluated datasets. Evaluation across 10 diverse datasets confirms statistically significant positive improvements (Wilcoxon $p = 0.002$), demonstrating that incremental learning without data sharing achieves at least parity with standard training --- and often surpasses it.
\end{abstract}
