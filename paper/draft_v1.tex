...
Table~\ref{tab:missingness} summarizes the results. All six natural-missingness datasets show statistically significant chi-squared tests ($p < 0.01$) and logistic regression AUC well above 0.5 (range: 0.63--0.86), confirming that missingness is structured and predictable from base features. In contrast, the four augmented datasets --- where nulls were injected randomly by design --- show non-significant chi-squared tests and logistic regression AUC near 0.5, confirming random missingness as expected.

This validation supports our claim that real-world feature availability patterns are non-random, and demonstrates that our framework operates under both structured and random missingness conditions.
...
\midrule
BankLoanSta & Augmented & $1.00$ & --- & Random \\
ClientRecord & Augmented & $1.4 \times 10^{-7}$ & 0.823 & Structured \\
MovieAugV2 & Augmented & $6.3 \times 10^{-51}$ & 0.514 & Random \\
