...
\item \textbf{Adaptive tree pruning for knowledge transfer:} We develop a validation-driven pruning mechanism that determines how much prior knowledge to retain when extending to new feature spaces. Bayesian optimization selects the optimal pruning level, with a built-in $k=0$ fallback that guarantees the framework never underperforms training from scratch. Adaptive pruning outperforms fixed strategies in 8 of 10 datasets.
...
MovieAugV2 & 112K & 50.0 & 0.9187 & 0.9185 & 0.8726 & 0.8726 & \textcolor{ForestGreen}{+0.0000} \\
